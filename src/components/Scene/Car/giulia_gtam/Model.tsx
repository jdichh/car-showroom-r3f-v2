  ...
  return (
    <group {...props} dispose={null} scale={4} position={[0, -1.7, 0]}>
      ...
      <mesh
        ...
        receiveShadow
        geometry={
          nodes.AlfaRomeo_GiuliaGTAm_2021ManufacturerPlate_Geo_lodA.geometry
        }
      ...
      <mesh
        ...
        receiveShadow
        geometry={
          nodes.AlfaRomeo_GiuliaGTAm_2021Kit1_Carbon1Livery_Geo_lodA.geometry
        }
      ...
      <mesh
        ...
        receiveShadow
        geometry={
          nodes.AlfaRomeo_GiuliaGTAm_2021InteriorTilling_Geo_lodA.geometry
        }
      ...
      <mesh
        ...
        receiveShadow
        geometry={
          nodes.AlfaRomeo_GiuliaGTAm_2021_Wheel_1Combined3DWheel_3DWheel_Front_
            .geometry
        }
      ...
      >
        <mesh
          ...
          geometry={
            nodes
              .AlfaRomeo_GiuliaGTAmReward_2021_CallipersCombinedCalliperExotic
              .geometry
          }
      ...
      <mesh
        ...
        receiveShadow
        geometry={
          nodes.AlfaRomeo_GiuliaGTAm_2021_Wheel_1Combined3DWheel_3DWheel_Fr
            .geometry
        }
        material={materials.Wheel}
        position={[-0.723, 0.2, 1.499]}
        rotation={[-Math.PI / 2, 0, 0]}
        scale={[-0.9, -1, -1]}
      >
        <mesh
          ...
          receiveShadow
          geometry={
            nodes.AlfaRomeo_GiuliaGTAmReward_2021_CallipersCombinedCalliperEx001
              .geometry
          }
          material={materials.Caliper}
          position={[-0.007, 0, 0]}
      ...
      <mesh
        ...
        receiveShadow
        geometry={
          nodes.AlfaRomeo_GiuliaGTAm_2021_Wheel_1Combined3DWheel_3DWheel_Fr001
            .geometry
        }
        material={materials.Wheel}
        position={[-0.726, 0.2, -1.328]}
      ...
      >
        <mesh
          ...
          receiveShadow
          geometry={
            nodes.AlfaRomeo_GiuliaGTAmReward_2021_CallipersCombinedCalliperEx
              .geometry
          }
          material={materials.Caliper}
          position={[-0.01, -0.029, 0]}
      ...
      <mesh
        ...
        receiveShadow
        geometry={
          nodes.AlfaRomeo_GiuliaGTAm_2021_Wheel_1Combined3DWheel_3DWheel_Fr002
            .geometry
        }
        material={materials.Wheel}
        position={[0.723, 0.2, 1.499]}
      ...
      >
        <mesh
          ...
          receiveShadow
          geometry={
            nodes.AlfaRomeo_GiuliaGTAmReward_2021_CallipersCombinedCalliperEx002
              .geometry
          }
          material={materials.Caliper}
          position={[-0.007, 0, 0]}
