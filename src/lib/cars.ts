...
export const cars = [
  ...
  },
  {
    ...
    height: "1,136 mm",
    weight: "1,525 kg",
    description: `The Lamborghini Aventador LP 750-4 Superveloce, released in 
    2015, was the highest performance model of the Lamborghini lineup until the 
    rise of the Aventador S in 2016 which introduced major improvements. The 
    Superveloce (abbreviated SV) simply means 'Super Fast'. The SV designation 
    dates back to the famed Miura, and is a moniker that is given only to the 
    highest performance flagship models of Lamborghini. The 6.5 litre naturally 
    aspirated V12 engine of the LP 750-4 SV produces 49 BHP more power than the 
    standard Aventador at 739 BHP. Combined with a 7 speed semiautomatic 
    transmission and all wheel drive, it reaches 0-100 km/h in 2.8 seconds, 
    200 km/h in 8.6 seconds, and 300 km/h in 24.9 seconds. If you keep on the 
    throttle beyond this, the car will continue to accelerate to speeds in excess 
    of 350 km/h. It also shows incredible stopping performance with a 100 km/h-0 
